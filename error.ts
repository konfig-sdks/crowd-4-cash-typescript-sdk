...
/**
 * This class provides a wrapper for network errors when making requests to C4C REST API
 */
export class Crowd4CashError extends Error {
  /**
   * The response body
   */
